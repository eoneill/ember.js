...
const svelte = require('./broccoli/svelte');
...
module.exports = function() {
  ...
  function buildPackages(packagesES) {
  ...
  // if we're also doing a svelte build, add the tree
  if (process.env.SVELTE === 'true') {
    const sveltePackages = buildPackages(svelte(packagesES));
    trees.push(new Funnel(sveltePackages, { destDir: 'svelte' }));
  }
